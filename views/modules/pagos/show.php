                                ...
                                if (!empty($DataPago)) {
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-10">
                                                <p>
                                                    <strong><i class="fas fa-sort-numeric-down-alt mr-1"></i> Numero</strong>
                                                <p class="text-muted">
                                                    <?= $DataPago->getNumero() ?>
                                                </p>
                                                <hr>
                                                ...
                                                <p class="text-muted">
                                                    <?= GeneralFunctions::formatCurrency($DataPago->getValor()) ?>
                                                </p>
                                                <hr>
                                                <p>
                                                    <strong><i class="fas fa-money-check mr-1"></i> Tipo</strong>
                                                <p class="text-muted">
                                                    <?= $DataPago->getTipo(); ?>
                                                </p>
                                                <hr>
                                                <p>
                                                    <strong><i class="far fa-calendar-alt mr-1"></i> Tipo</strong>
                                                <p class="text-muted">
                                                    <?= $DataPago->getFecha(); ?>
                                                </p>
                                                <hr>
                                                ...
                                                <p class="text-muted">
                                                    <?= $DataPago->getContrato()->getSiglas()." - ".$DataPago->getContrato()->getId() ?> <br>
                                                    <?= $DataPago->getContrato()->getObjeto()?> <br>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
