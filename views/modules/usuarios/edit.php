                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select id="tipoDocumento" name="tipoDocumento"
                                                                    class="custom-select">
                                                                <option <?= ($DataUsuario->getTipoDocumento() == "Cedula de Ciudadania") ? "selected" : ""; ?>
                                                                        value="Cedula de Ciudadania">Cedula de Ciudadania
                                                                </option>
                                                                <option <?= ($DataUsuario->getTipoDocumento() == "Cedula de Extranjeria") ? "selected" : ""; ?>
                                                                ...
                                                                <option <?= ($DataUsuario->getTipoDocumento() == "Nit") ? "selected" : ""; ?>
                                                                        value="Nit">Nit
                                                                </option>
                                                            </select>
                                                        </div>
