                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <select id="tipoDocumento" name="tipoDocumento" class="custom-select">
                                                        <option <?= (!empty($frmSession['tipoDocumento']) && $frmSession['tipoDocumento'] == "Cedula de Ciudadania") ? "selected" : ""; ?> value="Cedula de Ciudadania">Cedula de Ciudadania</option>
                                                        <option <?= (!empty($frmSession['tipoDocumento']) && $frmSession['tipoDocumento'] == "Cedula de Extranjeria") ? "selected" : ""; ?> value="Cedula de Extranjeria">Cedula de Extranjeria</option>
